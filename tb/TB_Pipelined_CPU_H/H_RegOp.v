...
module H_RegOp;
    ...
    initial begin
        ...
        expected[10] = 32'h00001001;
        expected[11] = 32'hFFFFEFFF;
        expected[12] = 32'h00001001;
        expected[14] = 32'h00009001;
        expected[15] = 32'h00001000;
        expected[16] = 32'h00004000;
        expected[17] = 32'h00001000;
        expected[18] = 32'h00001000;
        expected[19] = 32'h00000001;
        expected[20] = 32'h00000001;
    end
    ...
    initial begin
        ...
        $dumpfile("sim/h_reg_op.vcd");
        $dumpvars(1, H_RegOp.test_cpu, H_RegOp);
        ...
        if (errors == 0)
            $display("PASS: No Hazards Pipelined Register-Register Operations test");
        else
