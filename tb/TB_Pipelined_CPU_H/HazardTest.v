...
module HazardTest;
    ...
    initial begin
        ...
        expected[2]  = 32'hFFFFFFFD;
        expected[3]  = 32'hFFFFFFFA;
        expected[4]  = 32'h00000001;
        expected[5]  = 32'h0000000B;
        expected[6]  = 32'h0000001F;
        expected[7]  = 32'h00000000;
        expected[8]  = 32'h00000000;
        expected[9]  = 32'h00000000;

        expected[10] = 32'hFFFFFFFF;
        expected[11] = 32'hFFFFFFFD;
        expected[12] = 32'hFFFFFFFA;
        expected[13] = 32'h000000FF;
        expected[14] = 32'h0000FFFD;
        expected[15] = 32'h00010009;
    end
    ...
    initial begin
        ...
        $dumpfile("sim/hazard_test.vcd");
        $dumpvars(1, HazardTest.test_cpu, HazardTest);
        ...
        if (errors == 0)
            $display("PASS: Pipeline Hazards test");
        else
